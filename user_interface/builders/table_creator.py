...
class TableCreator:
    ...
    def create_grid(index: int) -> Grid:
        ...
        rect = pygame.Rect(cell_position, Grid.CELL_SIZE)
    ...
    def get_grid_position(index: int) -> Tuple[int, int]:
        ...
        cell_x_pos = Display.HORIZONTAL_BORDER_SIZE[0] + col * Grid.CELL_SIZE[0]
        cell_y_pos = Display.VERTICAL_BORDER_SIZE[0] + row * Grid.CELL_SIZE[1]
